...
func easyjsonD2b7633eDecodeAuthServiceModels(in *jlexer.Lexer, out *SecretQuestion) {
...
func easyjsonD2b7633eEncodeAuthServiceModels(out *jwriter.Writer, in SecretQuestion) {
	out.RawByte('{')
	first := true
	_ = first
	{
